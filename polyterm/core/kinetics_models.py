...
# ================= Combined First + Second Order Kinetics =================
# These are the kinetic equations for a polymerization with simultaneous
# first-order termination (e.g. CRT in ATRP) and second-order termination
# (disproportionation + combination). The model uses three rate ratios:
